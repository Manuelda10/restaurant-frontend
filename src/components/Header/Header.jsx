        ...
        <>
            <header className="header">
                <div className="hd-lg-container">
                    <LogoRestaurant fill="white" width="100"></LogoRestaurant>
                </div>
                <div className="hd-menu-container">
                    <nav>
                        <ul>
                            ...
                            <li><NavLink to={'/menu'}>Contacto</NavLink></li>
                            <li><NavLink to={'/menu'}>Nosotros</NavLink></li>
                        </ul>
                    </nav>
                </div>
                <div className="hd-user-container">
                    <svg width="30" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>cart_fill [#1154]</title>
                        <desc>Created with Sketch.</desc>
                        <defs>
                        </defs>
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Dribbble-Light-Preview" transform="translate(-260.000000, -3039.000000)" fill="white">
